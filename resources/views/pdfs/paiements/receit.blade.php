            ...
            <div id="block-content">
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        <!-- Colonne gauche -->
                        <td style="width: 50%; text-align: left; vertical-align: top;">
                            <p class="souscription-frais"><strong class="badge">Frais de souscription</strong> : <strong style="margin-left:10px; border-bottom:1px dashed #000;">{{$paiement->montant}} {{ env('CURRENCY') }}</strong></p>
                            <p class="phone-parent"><strong class="badge">Contact des parents</strong> : <strong style="margin-left:10px; border-bottom:1px dashed #000;">{{$paiement->apprenant?->parent?->detail?->phone}}</strong></p>
                        </td>
