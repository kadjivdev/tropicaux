...
export default function Create({ chargements, superviseurs }) {
    ...
    const submit = (e) => {
        ...
        post(route('depense-superviseur.store'), {
            onStart: () => {
                Swal.fire({
                        ...
                        <div className="bg-light p-3 rounded border mb-5">
                            {checkPermission('depense.superviseur.view') ?
                                (<div className=" text-center  items-center gap-4">
                                    <Link className="btn btn-sm bg-success bg-hover text-white" href={route("depense-superviseur.index")}> <CIcon icon={cilList} /> Liste des depenses</Link>
                                </div>) : null
                            }
