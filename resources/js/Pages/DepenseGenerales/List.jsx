    ...
    const deleteDepense = (e, depense) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                destroy(route('depense-generale.destroy', depense.id), {
                    onSuccess: () => {
                        Swal.close();
                        Swal.fire({
    ...
    const validatedDepense = (e, depense) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                patch(route('depense-generale.validate', depense.id), {
                    onSuccess: () => {
                        Swal.close();
                        Swal.fire({
        ...
        <AuthenticatedLayout
            header={
                <h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">
                    <CIcon className='text-success' icon={cilList} /> Gestion des depenses generales
                </h2>
            }
        >
            <Head title="Les depenses genrales" />
                    ...
                    <div className="mx-auto _max-w-7xl space-y-6 sm:px-6 lg:px-8 " style={{ overflowX: 'auto' }} >
                        {checkPermission('depense.superviseur.create') ?
                            (<div className="text-center  items-center gap-4">
                                <Link className="btn w-50 bg-success bg-hover text-white" href={route("depense-generale.create")}> <CIcon className='' icon={cibAddthis} /> Ajouter</Link>
                            </div>) : null
                        }
                                                                ...
                                                                <li>
                                                                    {checkPermission('depense.superviseur.edit') ?
                                                                        (<Link
                                                                            ...
                                                                            href={route('depense-generale.edit', depense.id)}
                                                                        >
