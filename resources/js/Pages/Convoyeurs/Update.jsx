...
export default function Update({ convoyeur }) {
    ...
    const {
        ...
        raison_sociale: convoyeur?.raison_sociale,
        phone: convoyeur?.phone,
        adresse: convoyeur?.adresse,
    ...
    const submit = (e) => {
        ...
        patch(route('convoyeur.update',convoyeur.id), {
            onStart: () => {
                Swal.fire({
        ...
        <AuthenticatedLayout
            header={
                <h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">
                    <CIcon className='text-success' icon={cilPencil} /> Modification du convoyeur <span className="badge bg-light text-warning border rounded">{convoyeur?.raison_sociale}</span>
                </h2>
            }
        >
            <Head title="Modifier un convoyeur" />
                        ...
                        <div className="bg-light p-3 rounded border mb-5">
                            {checkPermission('convoyeur.view') ?
                                (<div className=" text-center  items-center gap-4">
                                    <Link className="btn btn-sm bg-success bg-hover text-white" href={route("convoyeur.index")}> <CIcon icon={cilList} /> Liste des convoyeurs</Link>
                                </div>) : null
                            }
