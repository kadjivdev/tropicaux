...
export default function Update({ gestionnaire }) {
    ...
    const submit = (e) => {
        ...
        patch(route('gestionnaire.update',gestionnaire.id), {
            onStart: () => {
                Swal.fire({
        ...
        <AuthenticatedLayout
            header={
                <h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">
                    <CIcon className='text-success' icon={cilPencil} /> Modification du gestionnaire <span className="badge bg-light text-warning border rounded">{gestionnaire?.raison_sociale}</span>
                </h2>
            }
        >
            <Head title="Modifier un gestionnaire" />
                        ...
                        <div className="bg-light p-3 rounded border mb-5">
                            {checkPermission('gestionnaire.view') ?
                                (<div className=" text-center  items-center gap-4">
                                    <Link className="btn btn-sm bg-success bg-hover text-white" href={route("gestionnaire.index")}> <CIcon icon={cilList} /> Liste des gestionnaires</Link>
                                </div>) : null
                            }
