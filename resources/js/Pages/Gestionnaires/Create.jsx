        ...
        <AuthenticatedLayout
            header={
                <h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">
                    <CIcon className='text-success' icon={cibAddthis} /> Ajout des superviseurs
                </h2>
            }
        >
            <Head title="Ajouter un gestionnaire" />
                        ...
                        <div className="bg-light p-3 rounded border mb-5">
                            {checkPermission('gestionnaire.view') ?
                                (<div className=" text-center  items-center gap-4">
                                    <Link className="btn btn-sm bg-success bg-hover text-white" href={route("gestionnaire.index")}> <CIcon icon={cilList} /> Liste des gestionnaires de fonds</Link>
                                </div>) : null
                            }
                                    ...
                                    <div className="col-md-6">
                                        <div className='mb-3'>
                                            ...
                                            <TextInput
                                                ...
                                                placeholder="Ex: Gestionnaire Emmanuel"
