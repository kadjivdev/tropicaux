...
export default function Create({ schools, apprenants, trimestres, matieres }) {
    ...
    const submit = (e) => {
        ...
        post(route('interrogation.store'), {
            onSuccess: () => {
                Swal.close();
                Swal.fire({
                    icon: 'success',
                    title: 'Opération réussie',
                    text: 'Interrogation créee avec succès',
                });
            },
            onError: (e) => {
                Swal.close();
        ...
        <AuthenticatedLayout
            header={
                <h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">
                    <CIcon className='text-success' icon={cilLibraryAdd} /> Panel d'ajout des intérrogations d'école
                </h2>
            }
        >
