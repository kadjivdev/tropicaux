...
export default function Update({ fournisseurs, requete }) {
    ...
    useEffect(() => {
        console.log("Data en cours de traitement :", data)
    });
    ...
    const submit = (e) => {
        ...
        post(route('requete_fournisseur.update', { requete_fournisseur: requete.id }), {
            forceFormData: true,
            onSuccess: () => {
                Swal.close();
                Swal.fire({
                    title: '<span style="color: #2a7348;">👌 Opération réussie </span>', // yellow text
                    text: 'Requête mise à jour avec succès',
