...
export default function Update({ partenaire }) {
    ...
    const submit = (e) => {
        ...
        patch(route('partenaire.update',partenaire.id), {
            onStart: () => {
                Swal.fire({
        ...
        <AuthenticatedLayout
            header={
                <h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">
                    <CIcon className='text-success' icon={cilPencil} /> Modification du partenaire <span className="badge bg-light text-warning border rounded">{partenaire?.raison_sociale}</span>
                </h2>
            }
        >
